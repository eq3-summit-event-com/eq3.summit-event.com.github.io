...
$(document).on('click','.next2_5',function(){
    ...
    next_fs.show(); 
        ...
        else if(document.getElementById("NbrPourcentage").innerHTML === '90%')
        {
            ...
            document.getElementById("Pourcentage").style.height = height + 8*4.6 +'%';
            document.getElementById("Pourcentage").style.top =  top-8*4.6 +'%';
            document.getElementById("Pourcentage").style.transition = 'height .6s ease';
                document.getElementById("Pourcentage").style.transition = 'top .6s ease';
        } 
...
$(document).on('click','.previous2_5',function(){
