...
/* FOR  AVANT LAST QUESTION  CHAP 2 !!!! */
...
$(document).on('click','.next2last2',function(){
    // Show the button NEXT CHAPITRE
    document.getElementById("lastQST2").style.visibility = 'visible';
    console.log("teeeeeeest QST2 AVANT LASt ");
...
else if(document.getElementById("NbrPourcentage").innerHTML === '80%')
{
    ...
    document.getElementById("Pourcentage").style.height = height + 6*6.1 -2.6 +'%';
    document.getElementById("Pourcentage").style.top = top-6*6.1 +2.6 +'%';
    document.getElementById("Pourcentage").style.transition = 'height .6s ease';
        document.getElementById("Pourcentage").style.transition = 'top .6s ease';
} 
...
$(document).on('click','.previous22',function(){
    ...
    else if(document.getElementById("Nbr").innerHTML === '# 02')
    {
        ...
        // decreasing the pourcentage of the thermometre
